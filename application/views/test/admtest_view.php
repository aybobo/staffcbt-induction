                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Prep Test 10 - Admin Department</p>
                                        </div>
                                    </div>
                                    <!--<div class="col-md-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block" id="mybut10">
                                                        <div style="text-align: right; padding-right: 20px; padding-top: 10px;">Time: <?php echo $time;  ?></div>
                                                       <p>
                                                            This prep test is on admin department. You are expected to <strong>ATTEMPT ALL QUESTIONS</strong>. You have 5 minutes for this test. Cheers!<br>
                                                        <button class="button" onclick="myFunction10()">START QUIZ</button>
                                                       </p>
                                                        
                                                    </div>
                                                    <div class="card-block" id="myDIV10">
                                                        
                                                        <?php echo form_open('home/saveadmtest', ['class' => 'form-material']);
                                                        $i = 0;
