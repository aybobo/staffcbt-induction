                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        ...
                                        <p class="m-b-0">Prep Test 4 - Result</p>
                                    </div>
                                </div>
                                <!--<div class="col-md-4">
                                                    ...
                                                    foreach ($values as $value) {
                                                     ...
                                                     <div class="row">
                                                         <div class="col-md-2 offset-md-2">
                                                             <a href="<?=site_url('home/rectest')?>" class="btn btn-primary" >Retake Test</a>
                                                         </div>
                                                         <div class="col-md-3">
                                                             <a href="<?=site_url('home/ittest')?>" class="btn btn-primary" >Proceed to Next Prep Test</a>
                                                         </div>
                                                         <div class="col-md-3">
