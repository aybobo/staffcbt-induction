                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Prep Test 3 - Marketing</p>
                                        </div>
                                    </div>
                                    <!--<div class="col-md-4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block" id="mybut3">
                                                       ...
                                                       <p>
                                                        ...
                                                        <button class="button" onclick="myFunction3()">START QUIZ</button>
                                                       </p>
                                                        
                                                    </div>
                                                    <div class="card-block" id="myDIV3">
                                                        
                                                        <?php echo form_open('home/savemkttest', ['class' => 'form-material']);
                                                        $i = 0;
