            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        <?php echo form_open('Admin/updatepassword', ['class' => 'md-float-material form-material']); ?>
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <div class="btn-sign-in">
                                                <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Update Password</button>
                                            </div>
                                        </div>
                                    </div>
                                    <!--<hr/>
