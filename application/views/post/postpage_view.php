                                            ...
                                            <div class="col-md-6 offset-md-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <?php echo form_open('superadmin/addpost', ['class' => 'form-material']); ?>
                                                            ...
                                                            <div class="form-group form-default">
                                                                ...
                                                                <label class="float-label">Post Name</label>
                                                                <?php echo form_error('post', '<div class="text-danger">', '</div>'); ?>
                                                            </div>
                                                            
                                                            <div class="form-group form-default">
                                                                <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Add Post</button>
                                                            </div>
                                                        <?php echo form_close(); ?>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="card table-card">
                                                        ...
                                                        <div class="card-block">
                                                            <div class="">
                                                                <?php echo form_open('superadmin/editpoststatus', 
                                                                ...
                                                                <table class="table table-hover" id="datatable">
                                                                    ...
                                                                    <tbody>
                                                                    <?php foreach ($posts as $row) { $j++; ?>
                                                                    <tr>
                                                                        <?php $val = $row->postId; ?>
                                                                        <td><?php echo $j; ?></td>
                                                                        <td>
                                                                            <input type="checkbox" name="postId[<?php echo  $val ; ?>]" value="<?php echo $val; ?>">
                                                                        </td>
                                                                        <td>
                                                                            <a href="<?=base_url()?>superadmin/editpost/?id=<?php echo $val; ?>" style="text-decoration: underline;"><?php echo $row->postName; ?></a>
                                                                        </td>
                                                                        <td>
