                                            ...
                                            <div class="col-md-6 offset-md-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <?php echo form_open('superadmin/updatepost', ['class' => 'form-material']); ?>
                                                            ...
                                                            <div class="form-group form-default">
                                                                <input type="text" required="" name="post" class="form-control" value="<?php echo (isset($_POST['post']) ? $_POST['post'] : $post->postName); ?>">
                                                            ...
                                                            <input type="hidden" name="deptId" value="<?php echo $post->deptId; ?>">
                                                            <input type="hidden" name="oName" value="<?php echo $post->postName; ?>">
                                                            
                                                            <div class="form-group form-default">
                                                                <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Update Post</button>
                                                            </div>
                                                        <?php echo form_close(); ?>
                                                    </div>
                                                </div>
