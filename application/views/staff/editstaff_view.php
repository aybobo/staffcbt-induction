                                            ...
                                            <div class="col-md-6 offset-md-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <?php echo form_open('superadmin/updatestaff', ['class' => 'form-material']); ?>
                                                            <div class="form-group form-default">
                                                                <input type="text" required="" name="fname" class="form-control" value="<?php echo (isset($_POST['fname']) ? $_POST['fname'] : $staff->fname); ?>">
                                                            ...
                                                            <div class="form-group form-default">
                                                                <input type="text" required="" name="lname" class="form-control" value="<?php echo (isset($_POST['lname']) ? $_POST['lname'] : $staff->lname); ?>">
                                                                <span class="form-bar"></span>
                                                            ...
                                                            <div class="form-group form-default">
                                                                <input type="text" required="" name="email" class="form-control" value="<?php echo (isset($_POST['email']) ? $_POST['email'] : $staff->email); ?>">
                                                                <span class="form-bar"></span>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="branch" class="form-control" id="branch">
                                                                        <option value="<?php echo $staff->branchId; ?>"><?php echo $staff->branchName; ?></option>
                                                                        <?php
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="dept" id="dept" class="form-control">
                                                                        <option value="<?php echo $staff->deptId; ?>"><?php echo $staff->deptName; ?></option>
                                                                        <?php
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="post" id="post" class="form-control">
                                                                        <option value="<?php echo $staff->postId; ?>"><?php echo $staff->postName; ?></option>
                                                                    </select>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="role" class="form-control">
                                                                        ...
                                                                        <option value="<?php echo $v; ?>"><?php echo $var; ?></option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <input type="hidden" name="id" value="<?php echo $staff->userId; ?>">
                                                            <input type="hidden" name="oemail" value="<?php echo $staff->email; ?>">
                                                            
                                                            <div class="form-group form-default">
                                                                <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Update Staff Record</button>
                                                            </div>
                                                        <?php echo form_close(); ?>
                                                    </div>
                                                </div>
