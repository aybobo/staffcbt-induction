                                            ...
                                            <div class="col-md-6 offset-md-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <?php echo form_open('superadmin/addstaff', ['class' => 'form-material']); ?>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="branch" class="form-control" id="branch" onchange="mybranch1()">
                                                            ...
                                                            <div class="form-group row">
                                                                <!--<label class="col-sm-3 col-form-label">Department</label>-->
                                                                <div class="col-sm-12">
                                                                    <select name="dept" id="dept" class="form-control" onchange="mydept1()" disabled="FALSE">
                                                            ...
                                                            <div class="form-group row">
                                                                <!--<label class="col-sm-3 col-form-label">Department</label>-->
                                                                <div class="col-sm-12">
                                                                    <select name="post" id="post" class="form-control" disabled="FALSE">
                                                            ...
                                                            <div class="form-group form-default">
                                                                <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Add Staff</button>
                                                            </div>
                                                        <?php echo form_close(); ?>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card table-card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="">
                                                            <?php echo form_open('superadmin/editstaffstatus', 
                                                            ...
                                                            <table class="table table-hover" id="datatable">
                                                                ...
                                                                <tbody>
                                                                <?php foreach ($staffs as $row) { $j++; ?>
                                                                <tr>
                                                                    <?php $val = $row->userId; ?>
                                                                    <td><?php echo $j; ?></td>
                                                                    <td>
                                                                        <input type="checkbox" name="userId[<?php echo  $val ; ?>]" value="<?php echo $val; ?>">
                                                                    </td>
                                                                    <td>
                                                                        <?php
                                                                            $name = $row->fname . ' ' . $row->lname;
                                                                        ?>
                                                                        <a href="<?=base_url()?>superadmin/editstaff/?id=<?php echo $val; ?>" style="text-decoration: underline;"><?php echo $name; ?></a>
                                                                    </td>
                                                                    <td>
