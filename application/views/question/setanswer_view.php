                                            ...
                                            <div class="col-md-6 offset-md-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <?php echo form_open('superadmin/setanswer', ['class' => 'form-material']); ?>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="option" class="form-control">
                                                                        ...
                                                                        foreach($options as $option)
                                                                            { 
                                                                              echo '<option value="'.$option->optionId.'">'.$option->option.'</option>';
                                                                            }
                                                                        ?>
                                                                    </select>
                                                                    <?php echo form_error('option', '<div class="text-danger">', '</div>'); ?>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group form-default">
                                                                <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Set Answer</button>
                                                            </div>
                                                        <?php echo form_close(); ?>
                                                    </div>
                                                </div>
