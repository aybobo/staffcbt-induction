                                            ...
                                            <div class="col-md-6 offset-md-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <?php echo form_open('superadmin/setquestion', ['class' => 'form-material']); ?>
                                                            ...
                                                            <div class="form-group form-default">
                                                                <textarea class="form-control" required="" name="option1"></textarea>
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Option 1</label>
                                                                <?php echo form_error('option1', '<div class="text-danger">', '</div>'); ?>
                                                            </div>

                                                            <div class="form-group form-default">
                                                                <textarea class="form-control" required="" name="option2"></textarea>
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Option 2</label>
                                                                <?php echo form_error('option2', '<div class="text-danger">', '</div>'); ?>
                                                            </div>

                                                            <div class="form-group form-default">
                                                                <textarea class="form-control" required="" name="option3"></textarea>
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Option 3</label>
                                                                <?php echo form_error('option3', '<div class="text-danger">', '</div>'); ?>
                                                            </div>

                                                            <div class="form-group form-default">
                                                                <textarea class="form-control" required="" name="option4"></textarea>
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Option 4</label>
                                                                <?php echo form_error('option4', '<div class="text-danger">', '</div>'); ?>
                                                            </div>-->
