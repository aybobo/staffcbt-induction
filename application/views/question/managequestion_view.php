                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Manage Questions</p>
                                        </div>
                                    </div>
                                    <!--<div class="col-md-4">
                                                ...
                                                <div class="card table-card">
                                                    ...
                                                    <div class="card-block">
                                                        <div style="padding-left:10px; padding-right: 10px;">
                                                            <?php echo form_open('superadmin/editquestionstatus', 
                                                            ...
                                                            <table class="table table-hover" id="datatable">
                                                                ...
                                                                <?php
                                                                $j = 0;
                                                                foreach ($questions as $row) { $j++; ?>
                                                                <tr>
                                                                    <?php $val = $row->questionId; ?>
                                                                    <td><?php echo $j; ?></td>
                                                                    <td>
                                                                        <input type="checkbox" name="questionId[<?php echo  $val; ?>]" value="<?php echo $val; ?>">
                                                                    </td>
                                                                    <td>
