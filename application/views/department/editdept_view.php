                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Edit Department</p>
                                        </div>
                                    </div>
                                    <!--<div class="col-md-4">
                                            ...
                                            <div class="col-md-6 offset-md-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <?php echo form_open('superadmin/updatedept', ['class' => 'form-material']); ?>
                                                            <div class="form-group form-default">
                                                                <input type="text" required="" name="dept" class="form-control" value="<?php echo (isset($_POST['dept']) ? $_POST['dept'] : $row->deptName); ?>">
                                                            ...
                                                            <input type="hidden" name="id" value="<?php echo $row->deptId; ?>">
                                                            <input type="hidden" name="oName" value="<?php echo $row->deptName; ?>">
                                                            
                                                            <div class="form-group form-default">
                                                                <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Update Department</button>
                                                            </div>
                                                        <?php echo form_close(); ?>
                                                    </div>
                                                </div>
