                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Department Set-up</p>
                                        </div>
                                    </div>
                                    <!--<div class="col-md-4">
                                            ...
                                            <div class="col-md-6 offset-md-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <?php echo form_open('superadmin/adddept', ['class' => 'form-material']); ?>
                                                            ...
                                                            <div class="form-group form-default">
                                                                <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Add Department</button>
                                                            </div>
                                                        <?php echo form_close(); ?>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="card table-card">
                                                        ...
                                                        <div class="card-block">
                                                            <div class="">
                                                                <?php echo form_open('superadmin/editdeptstatus', 
                                                                ...
                                                                <table class="table table-hover" id="datatable">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><?php echo $j; ?></td>
                                                                        <td>
                                                                            <input type="checkbox" name="deptId[<?php echo  $val ; ?>]" value="<?php echo $val; ?>">
                                                                        </td>
                                                                        <td>
                                                                            <a href="<?=base_url()?>superadmin/editdept/?id=<?php echo $val; ?>" style="text-decoration: underline;"><?php echo $row->deptName; ?></a>
                                                                        </td>
                                                                        <td>
                                                                            <?php
                                                                                $status = $row->status;
