                                            ...
                                            <div class="col-md-6 offset-md-3">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <?php echo form_open('superadmin/updatebranch', ['class' => 'form-material']); ?>
                                                            <div class="form-group form-default">
                                                                <input type="text" required="" name="branch" class="form-control" value="<?php echo (isset($_POST['branch']) ? $_POST['branch'] : $row->branchName); ?>">
                                                            ...
                                                            <input type="hidden" name="oName" value="<?php echo $row->branchName; ?>">
                                                            
                                                            <div class="form-group form-default">
                                                                <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Update Branch</button>
                                                            </div>
                                                        <?php echo form_close(); ?>
                                                    </div>
                                                </div>
