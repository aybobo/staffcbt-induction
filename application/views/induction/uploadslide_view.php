                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Upload Training Slide</p>
                                        </div>
                                    </div>
                                    <!--<div class="col-md-4">
                                            ...
                                            <div class="col-md-6 offset-md-3">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Upload Training Slide</h5>
                                                        <!--<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>-->
                                                    </div>
                                                    <div class="card-block">
                                                        <?php echo form_open_multipart('superadmin/addslide', ['class' => 'form-material']); ?>

                                                            <!-- question -->

                                                            <div class="form-group form-default">
                                                                <textarea class="form-control" required="" name="title"></textarea>
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Training Title</label>
                                                            ...
                                                            <div class="form-group form-default">
                                                                ...
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Introduction</label>
                                                                <?php echo form_error('intro', '<div class="text-danger">', '</div>'); ?>
                                                            </div>
                                                            ...
                                                            <div class="form-group form-default">
                                                                ...
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Instructor</label>
                                                                <?php echo form_error('tutor', '<div class="text-danger">', '</div>'); ?>
                                                            </div>

                                                            <!-- option 4 -->

                                                            <div class="form-group form-default">
                                                                <input type="text" placeholder="yyyy-mm-dd" name="trainingdate" autocomplete="off" class="form-control" id="picker"/>
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Training Date</label>
                                                                <?php echo form_error('trainingdate', '<div class="text-danger">', '</div>'); ?>
                                                            </div>

                                                            
                                                            <div class="form-group">
                                                                <label class="cols-sm-2 control-label">Upload pdf of slide
                                                                </label>

                                                                <div class="col-sm-8 formspace">                                
                                                                    <input type="file" name="slide" size="20" />
                                                                </div>
                                                            </div>
                                                            
                                                            <div class="form-group form-default">
                                                                <button type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Save Slide</button>
                                                            </div>
                                                        <?php echo form_close(); ?>
                                                    </div>
                                                </div>
