...
function myFunction11() {
    var b = document.getElementById("mybut11");
...
document.getElementById('timer11').innerHTML = '<?php echo $time; ?>';
  //03 + ":" + 00 ;
...
function startTimer11() {
  ...
  var m = timeArray[0];
  var x = '';
  var s = checkSecond11((timeArray[1] - 1));
  if(s==59){m=m-1}
  if(m==0 && s==0){
