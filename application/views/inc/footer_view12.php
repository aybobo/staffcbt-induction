...
function myFunction12() {
    var b = document.getElementById("mybut12");
...
document.getElementById('timer12').innerHTML = '<?php echo $time; ?>';
  //03 + ":" + 00 ;
...
function startTimer12() {
  ...
  var m = timeArray[0];
  var x = '';
  var s = checkSecond12((timeArray[1] - 1));
  if(s==59){m=m-1}
  if(m==0 && s==0){
