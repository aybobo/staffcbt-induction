...
function myFunction10() {
    var b = document.getElementById("mybut10");
...
document.getElementById('timer10').innerHTML = '<?php echo $time; ?>';
  //03 + ":" + 00 ;
...
function startTimer10() {
  ...
  var m = timeArray[0];
  var x = '';
  var s = checkSecond10((timeArray[1] - 1));
  if(s==59){m=m-1}
  if(m==0 && s==0){
